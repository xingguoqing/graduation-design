...
//        jsonObject.put("addr","天上");
        ...
        mvc.perform(MockMvcRequestBuilders.post("/public/job/selPageJob?pageNum=1&pageSize=5")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content(JSONObject.toJSONString(userDto))
                .header("sign", "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIzIiwiaWF0IjoxNTE4NTg3NDg1LCJzdWIiOiJzdWIiLCJpc3MiOiJpc3N1ZXIifQ.27oq8EF83y13Xbblib8xLQ_i73GNTKMErnUCqImMfD4")
...
//        mvc.perform(MockMvcRequestBuilders.post("/public/user/login?userPhone=15611500952&password=123456")
//                .contentType(MediaType.APPLICATION_JSON_UTF8)
//                .accept(MediaType.APPLICATION_JSON))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andDo(MockMvcResultHandlers.print()).andReturn();
